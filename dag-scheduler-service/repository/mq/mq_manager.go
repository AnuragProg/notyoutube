...
Will be using service name as the group id so as to make it part of the horizontally scaled dag-scheduler-services cluster
*/
...
import (
	...
	mqTypes "github.com/anuragprog/notyoutube/dag-scheduler-service/types/mq"
